...
import com.alpha.work1a.Device;
import com.alpha.work1a.EthernetAdapter;
import com.alpha.work1a.Monitor;
...
public class Runner {
    public void run() {
        ...
        System.out.println("Sum of Circle areas (alternate): " + sumCircleArea(shapes));
    ...
    public double sumCircleArea(Shape[] shapes) {
        double area = 0;
        for (Shape s : shapes) {
            if (s instanceof Circle) {area = area + s.calcArea();}
        }
        return area;
    }
}